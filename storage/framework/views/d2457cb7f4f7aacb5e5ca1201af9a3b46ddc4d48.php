        ...
        <div class="navbar-content">
            <?php if(\Auth::user()->type != 'client'): ?>
                <ul class="dash-navbar">
                    <!--------------------- Start Dashboard ----------------------------------->
                    <?php if((\Auth::user()->show_hrm() == 1 && Gate::check('show hrm dashboard')) || (\Auth::user()->show_project() == 1 && Gate::check('show project dashboard')) || (\Auth::user()->show_account() == 1 && Gate::check('show account dashboard')) || (\Auth::user()->show_crm() == 1 && Gate::check('show crm dashboard')) || (\Auth::user()->show_pos() == 1 && Gate::check('show pos dashboard'))): ?>
...
<?php /**PATH /Users/pips/Development/NOW/Etc/erpips/resources/views/partials/admin/menu.blade.php ENDPATH**/ ?>